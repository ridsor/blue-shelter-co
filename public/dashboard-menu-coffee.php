      ...
      <section class="px-4 lg:px-0">
        <div class="container max-w-7xl">
          <div
                      ...
                      <form action="crud.php" id="form-menu" enctype="multipart/form-data" method="post">
                        ...
                        <div class="form-input">
                          <div class="px-2 flex gap-x-4">
                            <button type="submit" name="submit_menu_coffee" id="submit_coffee" class="submit_menu">
                              <svg
                                xmlns="http://www.w3.org/2000/svg"
                                width="27"
                                height="26"
            ...
            <div
              id="list-menu"
              class="coffee row grid gap-5 gap-y-10 md:gap-10 [grid-template-columns:repeat(auto-fill,minmax(100px,1fr))] sm:[grid-template-columns:repeat(auto-fill,minmax(150px,1fr))] pb-5">
                ...
                <div
                  ...
                  <button
                    ...
                    <img
                      ...
                      data-id='<?= json_encode($row) ?>' id="btn-edit" />
                  </button>
                  <button
